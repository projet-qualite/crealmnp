			...
			<div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
					...
					<div class="wizard-content">
						<form action="{{url("/modifier/$demande->id")}}" method="POST" enctype="multipart/form-data" class="tab-wizard wizard-circle wizard">
                            {{ csrf_field() }}
                            {!! method_field('PUT') !!}
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="departement_birthday" value="{{$demande->departement_naissance}}"  class="form-control" >
							...
							<section>
								...
								<div class="row">
									<div class="col-md-9 col-sm-12">
										<div class="form-group">
											<label>Adresse: </label>
											  <input id="user_input_autocomplete_address" onkeyup="modif()" value="{{$demande->adresse}}" name="user_input_autocomplete_address"
									...
									<div class="col-md-3 col-sm-12">
										<div class="form-group">
										  ...
										  <input id="postal_code" required name="postal_code" value="{{$demande->code_postal}}" disabled  class="form-control">
										  <input id="postal_code2" hidden name="postal_code2" value="{{$demande->code_postal}}" required  class="form-control">
									  </div>
									</div>
								...
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="form-group">
											<label>Ville</label>
											  <input id="locality" required name="locality" value="{{$demande->ville}}" disabled="true" class="form-control">
											  <input id="locality2" required hidden name="locality2" value="{{$demande->ville}}"  class="form-control">
										  </div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div id="form-message-danger" class="mb-4">
											<div class="alert alert-danger" role="alert">
												Importer seulement le document que vous voulez remplacer, s'il n'y a aucun document à remplacer, veuillez ne rien importer.
											</div>
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="file"  name="fichier1" class="form-control-file form-control height-auto">
										</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="file"  name="fichier2" class="form-control-file form-control height-auto">
										</div>
